...
const App = () => {
  ...
  const [postPerPage, setPostPerPage] = useState(postsOnPage);
  const postLength = posts.length;

  const onHandlePostChange = (start, end) => {
        ...
        <div className="row">
          <div className="col-md-12">
            <h1 className="text-center p-3">
              Welcome to my Reactjs pagination app
            </h1>
          </div>
          ...
          <div className="mx-auto fixed-bottom navbar navbar-expand-lg bg-dark navbar-dark py-3 px-5">
            <a
              href="https://www.github.com/RamanSharma100/reactjs-pagination-examples"
            ...
            <ul className="navbar-nav ml-auto">
              ...
              <li className="nav-item">
                <NavLink exact to={'/pagination-two'} className="nav-link">
                  Demo 2
                </NavLink>
              </li>
            </ul>
          ...
          <Switch>
            <Route exact path="/">
              <PaginationOne
                ...
                onHandlePost={onHandlePostChange}
              />
            </Route>
            <Route exact path="/pagination-two">
              <PaginationTwo
                postLength={postLength}
                postPerPage={postPerPage}
                onHandlePost={onHandlePostChange}
